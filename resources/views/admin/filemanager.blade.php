...
@section('meta_details')
    <title>File-Manager | AdminLTE</title>
    <link rel="stylesheet" href="{{ asset('admin-assets/file-manager/css/dashlite.css') }}">
                ...
                <div class="nk-fmg">
                    <div class="nk-fmg-aside toggle-screen-lg" data-content="files-aside" data-toggle-overlay="true"
                        ...
                        <div class="simplebar-wrapper" style="margin: 0px;">
                                                ...
                                                <div class="nk-fmg-aside-top" data-simplebar="init">
                                                    <div class="simplebar-wrapper" style="margin: 0px;">
                                                                        ...
                                                                        <ul class="nk-fmg-menu">
                                                                            <li class="active">
                                                                                <a class="nk-fmg-menu-item" href="#">
                                                                                    ...
                                                                                    <span
                                                                                        class="nk-fmg-menu-text">Home</span>
                                                                                </a>
                                                                            </li>
                                                                            <li>
                                                                                <a class="nk-fmg-menu-item" href="#">
                                                                                    ...
                                                                                    <span
                                                                                        class="nk-fmg-menu-text">Files</span>
                                                                                </a>
                                                                                <ul>
                                                                                    <li><a href="#"
                                                                                            class="nk-fmg-menu-item"><span
                                                                                                class="nk-fmg-menu-text">New
                                                                                                Files</span></a></li>
                                                                                    <li><a href="#"
                                                                                            class="nk-fmg-menu-item"><span
                                                                                                class="nk-fmg-menu-text">This
                                                                                                Months</span></a></li>
                                                                                    <li><a href="#"
                                                                                            class="nk-fmg-menu-item"><span
                                                                                                class="nk-fmg-menu-text">Older
                                                                                                Files</span></a></li>
                                                                                </ul>
                                                                            </li>
                                                                            <li>
                                                                                <a class="nk-fmg-menu-item" href="#">
                                                                                    ...
                                                                                    <span
                                                                                        class="nk-fmg-menu-text">Starred</span>
                                                                                </a>
                                                                            </li>
                                                                            <li>
                                                                                <a class="nk-fmg-menu-item" href="#">
                                                                                    ...
                                                                                    <span
                                                                                        class="nk-fmg-menu-text">Shared</span>
                                                                                </a>
                                                                            </li>
                                                                            <li>
                                                                                <a class="nk-fmg-menu-item" href="#">
                                                                                    ...
                                                                                    <span
                                                                                        class="nk-fmg-menu-text">Recovery</span>
                                                                                </a>
                                                                            </li>
                                                                            <li>
                                                                                <a class="nk-fmg-menu-item" href="#">
                                                                                    ...
                                                                                    <span
                                                                                        class="nk-fmg-menu-text">Settings</span>
                                                                                </a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                        ...
                                                        <div class="simplebar-placeholder"
                                                            style="width: auto; height: 374px;"></div>
                                                    </div>
                                                ...
                                                <div class="nk-fmg-aside-bottom">
                                                    <div class="nk-fmg-status">
                                                        ...
                                                        <div class="progress progress-md bg-light">
                                                            <div class="progress-bar" data-progress="5" style="width: 5%;">
                                                            </div>
                                                        </div>
                                                        <div class="nk-fmg-status-info">12.47 GB of 50 GB used</div>
                                                        <div class="nk-fmg-status-action">
                                                            <a href="#" class="link link-primary link-sm">Upgrade
                                                                Storage</a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="dropup">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a class="active"
                                                                            href="#"><span>Personal</span></a></li>
                                                                    <li class="divider"></li>
                                                                    <li><a class="link" href="#"><span>Upgrade
                                                                                Plan</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                            ...
                            <div class="simplebar-placeholder" style="width: auto; height: 1203px;"></div>
                        </div>
                        ...
                        <div class="nk-fmg-body-head d-none d-lg-flex">
                            ...
                            <div class="nk-fmg-actions">
                                <ul class="nk-block-tools g-3">
                                    <li>
                                        <div class="dropdown">
                                            <a href="#" class="btn btn-light" data-toggle="dropdown"><em
                                                    class="icon ni ni-plus"></em> <span>Create</span></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    <li><a href="#file-upload" data-toggle="modal"><em
                                    ...
                                    <li><a href="#file-upload" class="btn btn-primary" data-toggle="modal"><em
                                ...
                                <div class="nk-block-between position-relative">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="nk-block-tools g-1">
                                            ...
                                            <li class="d-lg-none mr-n1"><a href="#"
                                                    class="btn btn-trigger btn-icon toggle" data-target="files-aside"><em
                                                ...
                                                <div class="nk-file-info">
                                                    <a href="#" class="nk-file-link">
                                                        <div class="nk-file-title">
                                                            ...
                                                            <div class="nk-file-name">
                                                                <div class="nk-file-name-text">
                                                                    <span href="#" class="title">DashLite
                                                                        Resource</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="nk-block-between g-2">
                                        ...
                                        <div class="nk-block-head-content">
                                            <ul class="nk-block-tools g-3 nav">
                                                <li><a data-toggle="tab" href="#file-grid-view"
                                                        class="nk-switch-icon active"><em
                                                            class="icon ni ni-view-grid3-wd"></em></a></li>
                                                <li><a data-toggle="tab" href="#file-group-view"
                                                        class="nk-switch-icon"><em
                                                            class="icon ni ni-view-group-wd"></em></a></li>
                                                <li><a data-toggle="tab" href="#file-list-view"
                                                        class="nk-switch-icon"><em
                                                        ...
                                                        <div class="nk-file-info">
                                                            <div class="nk-file-title">
                                                                ...
                                                                <div class="nk-file-name">
                                                                    <div class="nk-file-name-text">
                                                                        <a href="#"
                                                                            class="title">Presentation.ppt</a>
                                                                        <div class="asterisk"><a href="#"><em
                                                                                    class="asterisk-off icon ni ni-star"></em><em
                                                                                    class="asterisk-on icon ni ni-star-fill"></em></a>
                                                                        </div>
                                                        ...
                                                        <div class="nk-file-title">
                                                            ...
                                                            <div class="nk-file-name">
                                                                <div class="nk-file-name-text">
                                                                    ...
                                                                    <div class="nk-file-star asterisk"><a
                                                                            href="#"><em
                                                                                class="asterisk-off icon ni ni-star"></em><em
                                                                                class="asterisk-on icon ni ni-star-fill"></em></a>
                                                                    </div>
                                                ...
                                                <div class="nk-file-item nk-file">
                                                    ...
                                                    <div class="nk-file-members">
                                                        ...
                                                        <div class="tb-shared"><em class="ni ni-link"
                                                                ...
                                                                title=""
                                                                data-original-title="People with the link can view"></em>
                                                        </div>
                                                    </div>
                                                    <div class="nk-file-actions">
                                                        <div class="dropdown">
                                                    ...
                                                    <div class="nk-file-info">
                                                        <div class="nk-file-title">
                                                            ...
                                                            <div class="nk-file-name">
                                                                <div class="nk-file-name-text">
                                                                    <a href="#"
                                                                        class="title">dashlite-package-v1.2.zip</a>
                                                                    <div class="nk-file-star asterisk"><a
                                                                            href="#"><em
                                                                                class="asterisk-off icon ni ni-star"></em><em
                                                                                class="asterisk-on icon ni ni-star-fill"></em></a>
...
@endsection
@push('javascript')
    <script src="{{ asset('admin-assets/file-manager/js/bundle.js') }}"></script>
    <script src="{{ asset('admin-assets/file-manager/js/file-manager.js') }}"></script>
    <script src="{{ asset('admin-assets/file-manager/js/script.js') }}"></script>
@endpush
